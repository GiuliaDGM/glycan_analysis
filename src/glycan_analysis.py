...
def write_glycan_ranges(output_file, glycans, num_glycans):
    """
...
if __name__ == "__main__":
    # Input files
    itp_file = "../GROMACS_files/PROA.itp"
    gro_file = "../GROMACS_files/IL3_GLY_R1_conv.gro"
    xtc_file = "../GROMACS_files/IL3_GLY_R1_conv.xtc"
    ...
    output_file = "glycan_ranges.txt"
    write_glycan_ranges(output_file, glycans, num_glycans)
